...
const Layout = () => {
  ...
  return (
    <>
      <div className='flex items-center justify-between py-3 px-4 sm:px-12 border-b border-gray-200 gap-2 bg-[#FFFFFF] min-h-[75px]'>
        <div onClick={() => { navigate('/admin'); scrollTo(0, 0) }} className="logo leading-none sm:text-3xl text-2xl cursor-pointer tracking-tight">
          Admin<span className='text-[rgb(70,95,255)] font-bold'> Panel</span>
        </div>
      ...
      <div className='flex min-h-[95vh] bg-gray-50'>
        <Sidebar />
        <Outlet />
      </div>
    </>
