  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex w-full justify-center px-4 py-8 md:px-8 lg:py-10 text-gray-600 h-full min-h-[95vh]'>
      <div className='bg-white flex flex-col w-full max-w-[700px] p-6 md:p-10 shadow rounded'>
        ...
        <h6 className='mt-4 text-sm'>Blog title</h6>
        <input type="text" placeholder='Type...' value={title} onChange={(e)=>setTitle(e.target.value)} className='w-full mt-2 p-2 min-h-10 text-gray-600 bg-gray-100 border border-gray-300 outline-none rounded text-sm' required />
        <h6 className='mt-4 mb-2 text-sm'>Blog Description</h6>
