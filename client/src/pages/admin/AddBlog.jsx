...
const AddBlog = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex items-center justify-center bg-[#f0f0f0] w-full sm:p-5 sm:pl-6 p-4 text-gray-600 h-full min-h-[85vh]'>
      <div className='bg-white h-fit flex flex-col w-full max-w-[700px] p-6 md:p-10 shadow rounded-xl'>
        <label htmlFor="image">
          <img src={!image ? upload_area : URL.createObjectURL(image)} className='rounded border border-gray-200 bg-gray-50 cursor-pointer max-h-24 max-w-24' alt="" />
