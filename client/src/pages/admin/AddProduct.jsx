        ...
        <div className="flex flex-col sm:gap-5 gap-4">
          <div className='grid sm:grid-cols-2 sm:gap-5 gap-4 h-full'>
            ...
            <div className='h-full w-full'>
              ...
              </div> : <div className='flex items-center gap-2'>{previewImage.map((img, index) => (
                <img key={index} src={img} className='rounded cursor-pointer max-h-26 max-w-24 bg-gray-100' alt="" />
              ))}</div>}
